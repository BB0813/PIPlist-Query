    ...
    if selected_option == 'all' or selected_option == 'requirements':
        ...
        with FileLock(lock_file_name):
            ...
            for req in requirements:
                ...
                matched_requirements.append([package_name, req_version, installed_version, req_version == installed_version])
            df_matched_requirements = pd.DataFrame(matched_requirements, columns=['包名', '要求版本', '已安装版本', '是否匹配'])
...
if __name__ == '__main__':
    ...
    save_to_excel(package_list=packages, languages=languages, frameworks=frameworks, requirements=requirements, file_name=args.file, selected_option=selected_option)
# PIPlist-Query V1.1
